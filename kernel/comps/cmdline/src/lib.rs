...
ostd::define_kernel_param_unimpl!("noreplace-smp");
ostd::define_kernel_param_unimpl!("reboot");
ostd::define_kernel_param_unimpl!("pci");
ostd::define_kernel_param_unimpl!("debug");
ostd::define_kernel_param_unimpl!("panic");
ostd::define_kernel_param_unimpl!("nr_cpus");
ostd::define_kernel_param_unimpl!("selinux");
ostd::define_kernel_param_unimpl!("initrd");
